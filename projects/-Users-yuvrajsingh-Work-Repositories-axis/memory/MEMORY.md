...
- [Snapshot rendering on Remotion Lambda: DONE, all compliance points closed (2026-09-24)](project_snapshot_render_lambda_migration.md) — separate `remotion/` TF root incl. replication; sites CLI-deployed; replica backfill gotchas inside
